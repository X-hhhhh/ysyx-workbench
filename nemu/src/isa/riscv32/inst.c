...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0 &&src1 != 0x80000000) ? (int32_t)src1 % (int32_t)src2 : (src2 == 0) ? src2 : 0);
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0 && src1 != 0x80000000) ? (int32_t)src1 / (int32_t)src2 : (src2 == 0) ? -1 : 0x80000000);
